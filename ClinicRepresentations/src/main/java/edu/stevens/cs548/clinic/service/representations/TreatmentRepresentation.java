...
public class TreatmentRepresentation extends TreatmentType {
	...
	public TreatmentRepresentation (TreatmentDto dto, UriInfo uriInfo) {
		...
		if (dto.getDrugTreatment() != null) {
			...
			dtrep.setName(dto.getDrugTreatment().getName());
			this.drugTreatment = (DrugTreatmentRepresentation) dtrep;
			...
			this.surgery = (SurgeryRepresentation) surRep;
			...
			this.radiology = (RadiologyRepresentation) radiologyRep;
		}
	}

	public TreatmentDto getTreatment() {
		TreatmentDto m = null;
		if (this.getDrugTreatment() != null || this.getSurgery() != null || this.getRadiology() != null){
		...
		if (this.getDrugTreatment() != null) {
			...
			d.setName(drugTreatment.getName());
